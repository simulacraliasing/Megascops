    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 flex-1 overflow-auto">
      ...
      <div id="max-frames" class="flex flex-col gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          >
          <div id="iframe-only" class="flex gap-2 w-auto items-center">
            <Switch bind:checked={config.configOptions.iframeOnly} />
      ...
      <div id="export-format" class="config-item">
        ...
        >
          <Select.Trigger>{config.configOptions.exportFormat}</Select.Trigger>
          <Select.Content>
